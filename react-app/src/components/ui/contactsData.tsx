/**
 * contactsData — ícones SVG e array de contatos compartilhados.
 *
 * Usado em: ProfilePhoto (card lateral) e Footer.
 * Para adicionar/editar contatos, altere apenas este arquivo.
 */
